...
const Label = ({children,...props}) => (
    <label className="block w-full text-gray-200 p-1" {...props}>{children}</label>
) 
     ...
     >
       {({
         ...
         <form onSubmit={handleSubmit}>
            ...
            <textarea className="w-full text-black px-4 py-2 rounded" rows={4} type="message" name="message" placeholder="type your message here..." 

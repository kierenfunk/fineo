  ...
  <div className="bg-gray-100">
    ...
    <div className="px-20 bg-cube bg-repeat bg-left">
      <div className="">
        ...
        <Section1 header="Innovate" className="bg-blue-700">
          Use data you already have and turn it into business
          intelligence to become a more informed decision maker.
        </Section1>
      </div>
    </div>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 px-20 gap-4 py-16">
      ...
      <Section2 imageSrc="/lead.png" header="Websites and Branding">
        Stand out from your competition with a blazingly fast and
        professional website. We work collaboratively with you to
      ...
      <Section2 imageSrc="/analysis.png" header="Analytics and Reporting">
        Understand your business on a deeper level with custom reporting.
        We can also analyse and validate your data, such as
        finding invalid or inactive emails and phone numbers.
      </Section2>
      <Section2 imageSrc="/bot.png" header="Automation and Bots">
        We are experts in automating away time consuming tasks so you can
        spend more time working on the tasks that
        bring you the most return.
      </Section2>
    </div>
    {/*
        <div className="px-20">
            <h2 className="text-gray-800 text-4xl font-bold my-2">
            Some of our favourite projects...</h2>
            <div className="flex flex-row">
                <h3 className="uppercase text-7xl italic font-bold py-16
                bg-gray-200 w-full hover:bg-gray-300 text-gray-800 transition-all">
                Commission Monitoring</h3>
            </div>
        </div>
        <p>
            Commission Monitoring
                ...
                Get a better understanding of your trail book and be in
                the know when something goes wrong.
            2. Custom integrations
                Standard integration tools dont take into account little details
                about your business causing easily avoidable problems.
                We do custom integrations with your aggregator software with other
                third party software required to make your business
                more efficient.
